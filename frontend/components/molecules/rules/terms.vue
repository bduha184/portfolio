...
<template>
  <v-dialog v-model="dialog" width="600px">
    ...
    <v-card class="py-5 px-3">
      ...
      <v-card-text>
        <p>
          この利用規約（以下，「本規約」といいます。）は，CycleCommunity（以下、「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１条（適応）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第２条（利用登録）</h3>
        <ol>
          <li>登録希望者が当サイトの定める方法によって利用登録を申請し，当サイトがこれを承認することによって，利用登録が完了するものとします。</li>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第３条（ユーザーIDおよびパスワードの管理）</h3>
        <ol>
          <li>ユーザーは，自己の責任において，本サービスのユーザーIDおよびパスワードを管理するものとします。</li>
          <li>ユーザーは，いかなる場合にも，ユーザーIDおよびパスワードを第三者に譲渡または貸与することはできません。当サイトは，ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーIDを登録しているユーザー自身による利用とみなします。</li>
          <li>
            ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，当サイトに故意又は重大な過失がある場合を除き，当サイトは一切の責任を負わないものとします。
          </li>
        </ol>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第４条（利用料金および支払方法）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第５条（禁止事項）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第６条（本サービスの提供の停止等）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第７条（著作権）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第８条（利用制限および登録抹消）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第９条（保証の否認および免責事項）</h3>
        <ol>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１０条（サービス内容の変更等）</h3>
        <p>
          当サイトは，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
        </p>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１１条（利用規約の変更）</h3>
        <p>
          当サイトは，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
        </p>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１２条（個人情報の取扱い）</h3>
        <p>
          当サイトは，本サービスの利用によって取得する個人情報については，「プライバシーポリシー」に従い適切に取り扱うものとします。
        </p>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１３条（通知または連絡）</h3>
        <p>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１４条（権利義務の譲渡の禁止）</h3>
        <p>
          ユーザーは，当サイトの書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
        </p>
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">第１５条（準拠法・裁判管轄）</h3>
        <ol>
