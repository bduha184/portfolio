  ...
  <v-dialog v-model="dialog" width="600px">
    ...
    <v-card class="py-5 px-3">
      ...
      <v-card-text>
        ...
        <h3 class="pt-5 pb-4 font-weight-bold text-h6">
        ...
        <ol>
          ...
          <li>
            ユーザーは，いかなる場合にも，ユーザーIDおよびパスワードを第三者に譲渡または貸与することはできません。当サイトは，ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーIDを登録しているユーザー自身による利用とみなします。
          </li>
          <li>
      ...
      <v-card-actions class="mx-auto">
        <v-btn class="text-center text-h4" @click="dialog = false"> × </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
