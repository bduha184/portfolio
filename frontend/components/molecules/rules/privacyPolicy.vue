<template>
  <v-dialog v-model="dialog" width="600px">
    ...
    <v-card class="py-5 px-3">
      ...
      <v-card-text>
        <p>
          CycleCommunity（以下，「当サイト」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
      ...
      <v-card-actions class="mx-auto">
        <v-spacer></v-spacer>
        <v-btn class="text-h4" @click="dialog = false"> × </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
